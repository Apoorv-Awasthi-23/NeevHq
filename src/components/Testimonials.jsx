...
//   return (
//     <div className=" mt-12 w-full h-full space-y-5 relative lg:px-24 md:px-16 
//     sm:px-7 px-4 flex items-center justify-center flex-col">
...
//             <SwiperSlide key={item.id}>
              ...
              //           {item.name}
              //         </p>
              //         <p className="text-slate-700 text-xs font-normal italic">
